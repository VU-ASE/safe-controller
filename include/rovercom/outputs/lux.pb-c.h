...
typedef struct _ProtobufMsgs__LuxSensorOutput ProtobufMsgs__LuxSensorOutput;
...
struct  _ProtobufMsgs__LuxSensorOutput
{
  ProtobufCMessage base;
  int32_t lux;
};
#define PROTOBUF_MSGS__LUX_SENSOR_OUTPUT__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&protobuf_msgs__lux_sensor_output__descriptor) \
    , 0 }


/* ProtobufMsgs__LuxSensorOutput methods */
...
typedef void (*ProtobufMsgs__LuxSensorOutput_Closure)
                 (const ProtobufMsgs__LuxSensorOutput *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor protobuf_msgs__lux_sensor_output__descriptor;
